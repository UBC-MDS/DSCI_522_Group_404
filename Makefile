...
results/accuracy.csv results/lgr_classification_report.csv results/lgbm_classification_report.csv results/svc_classification_report.csv results/hyper_parameters.csv : data/X_original.csv data/X_test_clean.csv data/X_train_clean data/y_original data/y_test data/y_train src/model.py 
